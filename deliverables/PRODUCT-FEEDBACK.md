...
- **Confirmed in the UI:** Automations → Output → "Pick a destination" lists only app connectors (21st.dev, Airtable, Amplitude, Apify, Apollo.io…). Searching "url" or "webhook" finds nothing. There's no generic HTTP/webhook destination.
